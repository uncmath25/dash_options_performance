        ...
        dbc.Container([
            ...
            dbc.Row([
                ...
                dbc.Col([
                    ...
                    dcc.Input(START_STOCK_PRICE_DEFAULT, type='text', id=INPUT_START_STOCK_PRICE_ID)
                ], width=2),
                dbc.Col([
                    html.H5('Option Price:'),
                    dcc.Input(OPTION_PRICE_DEFAULT, type='text', id=INPUT_OPTION_PRICE_ID)
                ], width=2),
                dbc.Col([
                    html.H5('Strike Price:'),
                    dcc.Input(STRIKE_PRICE_DEFAULT, type='text', id=INPUT_STRIKE_PRICE_ID)
                ], width=2),
                dbc.Col([
                    html.H5('Option Number:'),
                    dcc.Input(OPTION_NUMBER_DEFAULT, type='text', id=INPUT_OPTION_NUMBER_ID)
                ], width=2)
            ]),
            _build_spacing_div(5),
            dbc.Row([
